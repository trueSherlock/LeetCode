class Solution {
    ...
    Map<String,List<String>> wordFormsMap;
    ...
    public int ladderLength(String beginWord, String endWord, List<String> wordList) {
        ...
        wordList.forEach(w->{
            ...
            for(int i=0;i<w.length();i++){
                ...
                wordFormsMap.computeIfAbsent(w, k->new ArrayList<>()).add(wordForm);
            }
        });
    ...
    private int bfs(String src,String dest){
        ...
        for(int i=0;i<src.length();i++){
            ...
            wordFormsMap.computeIfAbsent(src, k->new ArrayList<>()).add(srcWordForm);
        }
        int level = 1;
