<h1>1651 - Shuffle String</h1><h2>Difficulty: Easy - <a href="https://leetcode.com/problems/shuffle-string/">shuffle-string</a></h2><p>You are given a string <code>s</code> and an integer array <code>indices</code> of the <strong>same length</strong>. The string <code>s</code> will be shuffled such that the character at the <code>i<sup>th</sup></code> position moves to <code>indices[i]</code> in the shuffled string.</p>
